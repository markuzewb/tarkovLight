...
| `SM_REMOTESESSION=1`, но `SESSIONNAME=Console` и id совпадают | процесс унаследован из чужого сеанса (запущен из терминала/планировщика RDP-сессии) | завершите и запустите `TarkovBright.exe` двойным кликом на своём рабочем столе |
